...
## Compatibility
### Operating Systems
- Data viewing is supported on all OS's
- Bluetooth Wifi setup is **not** supported on iOS or ipadOS

### Browsers
- Data viewing is supported on all browsers
- Bluetooth Wifi setup requires Web Bluetooth and is **only** supported on Google Chrome and Microsoft Edge (See [/Frontend/Web Bluetooth](https://microgreensolarcorp.github.io/Microgreen_Data_Service_Docs/frontend/web-bluetooth/) for more information)
